import quality from "./../media/img/misc/quality.webp";
import cellar from "./../media/img/misc/cellar.webp";
import making from "./../media/img/misc/making.webp";
import organic from "./../media/img/misc/organic.webp";
import terroirs from "./../media/img/misc/terroirs.webp";
...
export const winery_content = [
  {
    ...
    img: terroirs,
    alt: "Quality wines over a barrel in the vineyard",
  ...
  },
  {
    ...
    alt: "Michel and Xavier in the vineyard doing some soil work",
    img: quality,
  ...
  },
  {
    ...
    img: cellar,
    alt: "Wine cellar with oak barrels in the domaine",
...

  {
    ...
    alt: "White rosé and red wine in wine glasses",
