...
export default class VideoLightbox extends Component {
  render() {
    return (
      ...
      >
        <div className="mw-100 pa3 vh-100 pb2 mt4 pt5 flex flex-column items-center justify-center">
          <ReactPlayer
          ...
          <div>
            <div
              key={1}
              className="ctaItem flex items-center pointer w-100 ma2 mb5-l mb4-m f4-l f5 grow br2 ba bw1 ph3 pv2 dib white hover-bg-black-60 bgblur"
              onClick={(e) => this.props.closeCallback(e)}
            >
